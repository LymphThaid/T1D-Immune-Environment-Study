...
**Annotation by label transfer.Rmd:** Showing the process of ReBeLa: transfer the cell type annotation from the annotated public dataset to our own data, generate clusters with high resolution, and remove the clusters with a mixture of annotated cell types.
